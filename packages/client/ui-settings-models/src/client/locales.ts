...
export const en = {
  ...
  oauthOverride: 'This route names an API token reference. Remove its apiKeyEnv in settings.yaml to use ChatGPT sign-in.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  oauthOverride: '此路由设置了 API 令牌引用。请在 settings.yaml 中移除它的 apiKeyEnv 后使用 ChatGPT 登录。',
