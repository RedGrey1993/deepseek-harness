...
export const en = {
  oauthRefresh: 'Refresh sign-in status',
  oauthAccount: 'Provider account',
  oauthLoading: 'Checking sign-in…',
  oauthConnected: 'Signed in',
  oauthDisconnected: 'Not signed in',
  oauthSigningIn: 'Updating account…',
  oauthSignIn: 'Sign in',
  oauthSignOut: 'Sign out',
  oauthOpenPage: 'Open authorization page',
  oauthCode: 'Verification code',
  oauthContinue: 'Continue',
  oauthChoose: 'Choose an option',
  oauthSaved: 'Signed in. Apply to save the provider settings.',
  oauthCancelled: 'Sign-in cancelled.',
  oauthInterrupted: 'The sign-in connection ended. Please try again.',
  oauthLocalOnly: 'Open the Host through localhost to manage account sign-in.',
  oauthUnavailable: 'The Host has no sign-in flow for this provider.',
  oauthOverride: 'An API key overrides account sign-in. Clear the API key input and remove this route’s apiKeyEnv in the active profile’s cordis.patch.yml to use account sign-in.',
  oauthInFlight: 'Sign-in is already running in another page.',
  nav: 'Models',
  deepSeekAccount: 'DeepSeek Account',
  title: 'Models',
  intro: 'Configure API keys or sign in to use models from the following providers.',
  edit: 'Edit',
  ...
  nativeCredentialConfigured: 'Authentication configured',
...
export const zh: { [Key in keyof typeof en]: string } = {
  oauthRefresh: '刷新登录状态',
  oauthAccount: '提供方账号',
  oauthLoading: '正在检查登录状态…',
  oauthConnected: '已登录',
  oauthDisconnected: '未登录',
  oauthSigningIn: '正在处理账号授权…',
  oauthSignIn: '登录账号',
  oauthSignOut: '退出登录',
  ...
  oauthContinue: '继续',
  oauthChoose: '请选择',
  oauthSaved: '登录成功。点击应用保存提供方配置。',
  oauthCancelled: '已取消登录。',
  oauthInterrupted: '登录连接已中断，请重试。',
  oauthLocalOnly: '请通过 localhost 访问 Host 后管理账号登录。',
  oauthUnavailable: 'Host 未加载此提供方的登录流程。',
  oauthOverride: 'API 密钥会覆盖账号登录。请清空 API 密钥输入框，并在当前 profile 的 cordis.patch.yml 中移除此路由的 apiKeyEnv 后使用账号登录。',
  oauthInFlight: '另一个页面正在进行登录。',
  nav: '模型',
  deepSeekAccount: 'DeepSeek 账号',
  title: '模型',
  intro: '配置 API 密钥或登录账号，即可使用各提供方的模型。',
  edit: '编辑',
  ...
  nativeCredentialConfigured: '认证已配置',
